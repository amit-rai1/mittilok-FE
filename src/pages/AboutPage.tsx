...
export default function AboutPage() {
  usePageTitle("About");
  return (
    <PageShell narrow eyebrow="About MittiLok" title="Premium nursery experience, rooted in trust" text="MittiLok Nursery brings healthy plants, careful packaging, and friendly gardening support to homes across India.">
